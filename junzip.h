...
typedef struct {
#pragma pack(push,1) // Supposedly, this is supported on GCC as of certain versions, definitely 4.0 and greater. *Important for porting - make sure that something equivalent is done for your compiler, otherwise archives will fail to load due to wrong offsets in reading/seeking.
	uint32_t signature;
